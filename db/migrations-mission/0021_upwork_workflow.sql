...
CREATE TABLE mission_upwork_accounts (
...
CREATE TABLE mission_upwork_work (
 id TEXT PRIMARY KEY, account_id TEXT NOT NULL REFERENCES mission_upwork_accounts(account_id),
 tenant_id TEXT NOT NULL, contract_id TEXT NOT NULL UNIQUE, milestone_id TEXT NOT NULL UNIQUE,
...
CREATE TABLE mission_upwork_payouts (
 payout_id TEXT PRIMARY KEY, work_id TEXT NOT NULL UNIQUE REFERENCES mission_upwork_work(id),
...
CREATE TABLE mission_upwork_events (
 id TEXT PRIMARY KEY, subject_id TEXT NOT NULL, stage TEXT NOT NULL,
 evidence_hash TEXT NOT NULL, created_at TEXT NOT NULL
);
CREATE TABLE mission_upwork_api_limits (
 bucket TEXT NOT NULL, bucket_start BIGINT NOT NULL, hits INTEGER NOT NULL,
 PRIMARY KEY(bucket,bucket_start)
);

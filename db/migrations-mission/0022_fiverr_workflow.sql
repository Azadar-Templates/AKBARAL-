...
CREATE TABLE mission_fiverr_accounts (
...
CREATE TABLE mission_fiverr_work (
 id TEXT PRIMARY KEY, account_id TEXT NOT NULL REFERENCES mission_fiverr_accounts(account_id),
 order_id TEXT NOT NULL UNIQUE,
 buyer_id TEXT NOT NULL, scope_hash TEXT NOT NULL, gross_cents INTEGER NOT NULL CHECK(gross_cents>0),
 seller_earnings_cents INTEGER CHECK(seller_earnings_cents>0),
...
CREATE TABLE mission_fiverr_payouts (
 payout_id TEXT PRIMARY KEY, work_id TEXT NOT NULL UNIQUE REFERENCES mission_fiverr_work(id),
...
CREATE TABLE mission_fiverr_events (

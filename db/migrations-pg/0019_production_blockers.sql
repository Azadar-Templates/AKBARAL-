-- PostgreSQL twin of db/migrations/0019_production_blockers.sql.
...
CREATE TABLE workforce_staged_knowledge (
  ...
  staged_at TEXT NOT NULL DEFAULT (to_char(now() at time zone 'utc', 'YYYY-MM-DD"T"HH24:MI:SS.MS"Z"'))
);
...
UPDATE economy_policy SET max_economy_agents = 5000, updated_at = to_char(now() at time zone 'utc', 'YYYY-MM-DD"T"HH24:MI:SS.MS"Z"')

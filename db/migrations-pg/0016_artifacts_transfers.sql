...
-- PostgreSQL twin. See db/migrations/0016_artifacts_transfers.sql for the
-- documented contract — identical intent, PG dialect (no divergent syntax
-- is used in this migration).
--

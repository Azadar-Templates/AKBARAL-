...
import { invokeGoogleChat } from '../src/mission/chat-provider';
...
main().catch(() => {
  ...
  process.stderr.write('Private chat worker stopped or refused startup. Review owner/vault configuration and durable job state.\n');

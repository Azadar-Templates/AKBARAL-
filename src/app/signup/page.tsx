...
export const metadata: Metadata = {
  ...
  description:
    'Create your AKBARAL! account. A real route so the registration screen survives a refresh, a bookmark or a shared link.',
  // An application surface: reachable and refreshable, never a marketing page.
  robots: { index: false, follow: false },
};

/**
 * /signup — a real route for the `register` screen of the single-page application.
 *
 ...
 * `public/app.js` maps this path to the `register` screen; the shell is identical

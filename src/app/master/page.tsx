...
export const metadata: Metadata = {
  title: 'MASTER — AKBARAL!',
  description:
    'The MASTER workspace: one goal in, a planned, verified result out. A real route so the workspace can be bookmarked and refreshed.',
  // An application surface: reachable and refreshable, never a marketing page.
  robots: { index: false, follow: false },
};

/**
 * /master — a real route for the `master` screen of the single-page application.
 *
 ...
 * `public/app.js` maps this path to the `master` screen; the shell is identical

  ...
  return (
    <html lang="en" data-theme="dark">
      <head>
        ...
        />
        <link rel="stylesheet" href="/tokens.css?v=akbaral-lux-8" />
        <link rel="stylesheet" href="/styles.css?v=akbaral-lux-8" />
      </head>
      <body>
        {children}
        <Script src="/app.js?v=akbaral-lux-8" strategy="afterInteractive" />
      </body>
    </html>
  );
}

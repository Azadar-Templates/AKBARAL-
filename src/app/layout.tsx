  ...
  return (
    <html lang="en" data-theme="dark">
      <head>
        ...
        <link rel="stylesheet" href="/assets/tokens.css?v=akbaral-lux-14" />
        <link rel="stylesheet" href="/assets/styles.css?v=akbaral-lux-14" />
      </head>
      <body>
        {children}
        <Script src="/assets/app.js?v=akbaral-lux-14" strategy="afterInteractive" />
      </body>
    </html>
  );
}

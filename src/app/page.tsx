...
<noscript><style>{`#boot-veil{display:none !important}#screen-landing{display:block !important}`}</style></noscript><div id="boot-veil" aria-hidden="true"><div className="boot-core"><span className="boot-ring"></span><span className="boot-ring r2"></span><span className="boot-mark">A!</span></div><div className="boot-word">AKBARAL!</div><div className="boot-tagline">ONE INTELLIGENCE · EVERY SOLUTION</div><div className="boot-line"><i></i></div></div><div id="toast-root" aria-live="polite" aria-atomic="false"></div><a className="skip-link" href="#app-root">
  Skip to content</a><header className="site-header" id="site-header"><div className="header-bar"><a className="brand" href="#/" aria-label="AKBARAL home"><span className="brand-mark" aria-hidden="true"><span className="brand-mark-glow"></span>
      ...
      <section className="screen screen-default" id="screen-economy" hidden><div className="aw-container"><div className="page-head"><div><p className="eyebrow" data-kicker="Private"></p><h1>
        ...
        Propose transfer</button></div><div id="economy-transfers" className="econ-list"></div></div><div className="panel"><h3>Workforce overview</h3><div className="stat-grid" id="economy-workforce" aria-live="polite"></div><div id="economy-primaries" className="econ-list"></div></div><div className="panel"><h3>Agent inspector</h3><div className="econ-controls"><input id="agent-inspector-slug" placeholder="agent slug, e.g. web-research-001" aria-label="Inspector agent slug" /><button className="btn" id="agent-inspector-load" type="button">Inspect agent</button></div><div id="economy-agent" className="econ-list"></div></div><div className="panel"><h3>Command console (owner → agent)</h3><div className="econ-controls"><input id="command-slug" placeholder="agent slug" aria-label="Command agent slug" /><input id="command-text" placeholder="instruction — specific, verifiable, policy-compliant" aria-label="Command instruction" /><button className="btn btn-primary" id="command-send" type="button">Issue command</button></div><div id="economy-command" className="econ-list"></div><div id="economy-commands" className="econ-list"></div></div><div className="panel"><h3>

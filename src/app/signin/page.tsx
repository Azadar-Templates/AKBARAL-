...
export const metadata: Metadata = {
  ...
  description:
    'Sign in to AKBARAL! (email/password or a configured provider). A real route so the sign-in screen survives a refresh, a bookmark or a shared link.',
  // An application surface: reachable and refreshable, never a marketing page.
  robots: { index: false, follow: false },
};

/**
 * /signin — a real route for the `login` screen of the single-page application.
 *
 ...
 * `public/app.js` maps this path to the `login` screen; the shell is identical

...
describe('credentials', () => {
  ...
  it('production core launch requires ONLY DATABASE_URL and SESSION_SECRET (no integration credentials)', () => {
    ...
    const optionalIntegrations = [
      ...
      'OAUTH_APPLE_BASE_URL', 'OAUTH_GOOGLE_BASE_URL', 'OAUTH_GITHUB_BASE_URL', 'OAUTH_FACEBOOK_BASE_URL', 'OAUTH_MS_BASE_URL',
      'FACEBOOK_CLIENT_ID', 'FACEBOOK_CLIENT_SECRET', 'MS_CLIENT_ID', 'MS_CLIENT_SECRET',
    ];

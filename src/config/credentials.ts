...
export const INTEGRATION_DEFINITIONS: IntegrationDefinition[] = [
  ...
  },
  {
    ...
    name: 'Page fetch',
    kind: 'fetch',
    description: 'Readable page extraction. Defaults to fetching public source URLs directly with SSRF protection.',
    requiredEnv: [],
    optionalWhenUnset: true,
    defaultMode: 'direct public fetch — AKBARAL_PAGE_FETCH_ENDPOINT optional custom https:// fetch proxy',
  },
  {
    key: 'smtp',
    name: 'SMTP email',
  ...
  },
  {
    ...
    name: 'Apple OAuth',
    kind: 'oauth',
    description: 'Sign in with Apple. Disabled when unconfigured; email/password auth remains.',
    requiredEnv: ['APPLE_CLIENT_ID', 'APPLE_KEY_ID', 'APPLE_TEAM_ID', 'APPLE_PRIVATE_KEY'],
    optionalWhenUnset: true,
    defaultMode: 'email/password auth only — Apple disabled when APPLE_* unconfigured',
  },
  {
    key: 'oauth_microsoft',
